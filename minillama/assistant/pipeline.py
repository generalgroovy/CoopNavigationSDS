...
from minillama.caller.agents import STATION_PATTERN, build_messages, clean_reply, fallback_reply
from minillama.caller.prompting import build_agent_b_phase_instruction, build_agent_b_system
from minillama.assistant.config import MAX_REPAIR_ATTEMPTS, REPAIR_SIMILARITY_THRESHOLD
...
def build_prompt_from_messages(messages):
    ...
    from minillama.network.model_adapters import messages_to_prompt
