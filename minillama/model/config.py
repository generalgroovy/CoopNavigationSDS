...
CHAT_TIMEOUT_SEC = float(os.environ.get("MINILLAMA_CHAT_TIMEOUT_SEC", "3"))

MAX_NEW_TOKENS = int(os.environ.get("MINILLAMA_MAX_NEW_TOKENS", "64"))
GENERATION_MAX_TIME_SEC = float(os.environ.get("MINILLAMA_GENERATION_MAX_TIME_SEC", "2"))
...
TRAVEL_TIME_OVERRIDES = {
    ("Core Tram", "Bravo", "Golf"): 4,
    ("Core Tram", "Harbor", "Sierra"): 3,
    ("Ring", "Harbor", "Sierra"): 6,
}
...
ACCEPTABLE_DURATION_RATIO = float(os.environ.get("MINILLAMA_ACCEPTABLE_DURATION_RATIO", "1.5"))
MIN_STAGE_SUBOPTIMAL_OPTIONS = int(os.environ.get("MINILLAMA_MIN_STAGE_SUBOPTIMAL_OPTIONS", "1"))
REQUIRE_STAGE_SUBOPTIMAL_OPTIONS = os.environ.get("MINILLAMA_REQUIRE_STAGE_SUBOPTIMAL_OPTIONS", "1").lower() in {"1", "true", "on", "yes"}
