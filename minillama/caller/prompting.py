...
from minillama.caller.config import AGENT_RULES
from minillama.caller.personas import preference_text
from minillama.caller.prompt_data import caller_prompt_context, compact_prompt_context
...
def generate_agent_a_template(turn, persona, scenario, conversation=None):
    ...
    from minillama.network.route_planner import fmt_time
...
def valid_agent_b_route_count(conversation, scenario, allowed_modes):
    ...
    from minillama.analysis.route_interpreter import NaturalRouteInterpreter
    from minillama.network.route_planner import estimate_route_time
...
def best_prior_route_duration(conversation, scenario):
    ...
    from minillama.analysis.route_interpreter import NaturalRouteInterpreter
    from minillama.network.route_constraints import route_allowed_modes
    from minillama.network.route_planner import estimate_route_time
