...
def write_conversation_protocol(result, output_dir):
    ...
    paths = {
        "protocol": condition_dir / "protocol.json",
        "transcript_txt": condition_dir / "conversation_transcript.txt",
        "conversation_wav": condition_dir / "conversation.wav",
        "audio_manifest": condition_dir / "audio_manifest.json",
    ...
    audio_manifest = remove_compiled_turn_audio_sources(
        audio_manifest,
        [condition_dir.parent, condition_dir.parent.parent],
    )
