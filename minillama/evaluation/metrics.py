...
METRIC_FAMILY_SPECS = [
    ...
    },
    {
        ...
        "metrics": [
            ...
            ("vad_miss_rate", "Miss"),
            ("vad_detection_error_rate", "Det Err"),
            ("vad_speech_non_speech_f1", "Speech F1"),
    ...
    },
    {
        ...
        "metrics": [
            ...
            ("diarization_overlap_detection_f1", "Overlap F1"),
        ],
    },
    {
        "title": "ASR",
    ...
    },
    {
        "title": "SLU",
        "metrics": [
            ("slu_intent_accuracy", "Intent Acc"),
            ("slu_intent_error_rate", "Intent Err"),
            ("slu_slot_f1", "Slot F1"),
            ("slu_slot_error_rate", "Slot Err"),
            ("slu_concept_error_rate", "Concept Err"),
            ("slu_sentence_semantic_accuracy", "Sentence Sem"),
            ("slu_semantic_frame_accuracy", "Frame Acc"),
        ],
    },
    {
        "title": "DST",
        "metrics": [
            ...
            ("dst_average_goal_accuracy", "Avg Goal"),
            ("dst_requested_slot_f1", "Req Slot F1"),
    ...
    },
    {
        "title": "Policy / DM",
        "metrics": [
            ("policy_dialog_act_accuracy", "Dialog Act Acc"),
            ("policy_dialog_act_f1", "Dialog Act F1"),
            ("policy_next_action_accuracy", "Next Action"),
            ("policy_tool_call_exact_match", "Tool Exact"),
            ("policy_parameter_exact_match", "Param Exact"),
    ...
    },
    {
        ...
        "metrics": [
            ...
            ("tool_api_success_rate", "API Success"),
    ...
    },
    {
        ...
        "metrics": [
            ...
            ("nlg_rouge", "ROUGE"),
            ("nlg_meteor", "METEOR"),
            ("nlg_bert_score", "BERTScore"),
            ("nlg_slot_realization_accuracy", "Slot Realization"),
            ("nlg_delexicalized_bleu", "Delex BLEU"),
    ...
    },
    {
        "title": "TTS",
        "metrics": [
            ("tts_predicted_mos", "Pred MOS"),
            ("tts_intelligibility_wer", "Intelligibility WER"),
            ("tts_stoi", "STOI"),
            ("tts_mcd", "MCD"),
            ("tts_pesq", "PESQ"),
            ("tts_speechbert_score", "SpeechBERT"),
            ("tts_speaker_similarity", "Speaker Sim"),
            ("tts_f0_correlation", "F0 Corr"),
        ],
    },
    {
        "title": "Runtime",
        "metrics": [
            ("runtime_end_of_turn_detection_accuracy", "EOT Acc"),
            ("runtime_endpointing_latency_sec", "Endpoint Latency"),
            ("runtime_barge_in_true_positive_rate", "Barge TP"),
    ...
    },
    {
        ...
        "metrics": [
            ...
            ("posthoc_robustness_by_environment_gap", "Env Gap"),
            ("posthoc_cost_per_success", "Cost / Success"),
            ("posthoc_safety_refusal_precision", "Safety Prec"),
            ("posthoc_safety_refusal_recall", "Safety Rec"),
