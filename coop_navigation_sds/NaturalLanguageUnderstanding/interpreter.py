...
from coop_navigation_sds.NaturalLanguageGeneration.caller.agents import STATION_LOOKUP, STATION_PATTERN
from coop_navigation_sds.Configuration.metrics import ROUTE_INTERPRETER_SCORING
from coop_navigation_sds.TransportNetwork.network import ADJACENCY, LINES
from coop_navigation_sds.TransportNetwork.routes import estimate_route_time, line_direction_sequences, route_is_valid, segment_travel
...
class NaturalRouteInterpreter:
    ...
    def _route_from_named_line_legs(self, text):
        """Parse compact legs such as 'metro line M1 from Alpha to Echo'."""
        legs = []
