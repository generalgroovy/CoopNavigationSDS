...
class MainControllerTests(unittest.TestCase):
    ...
    def test_default_config_is_speech_first_and_keeps_gui_optional(self):
        ...
        self.assertEqual(config["max_turn_elapsed_sec"], 2.0)
        self.assertEqual(config["calculation_max_time_sec"], 2.0)
        self.assertEqual(config["agent_a_words_per_minute"], 210)
        self.assertEqual(config["agent_b_words_per_minute"], 220)
        self.assertEqual(config["min_utterance_sec"], 0.25)
        self.assertEqual(config["max_utterance_sec"], 1.1)
