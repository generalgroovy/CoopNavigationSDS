...
WRAPPER="${WRAPPER:-${ROOT}/slurm/finalize_large1_results.sbatch}"
...
echo "  JOB_ID=${job_id} COUNT_RUNS=0 INTERVAL_SECONDS=120 bash scripts/monitor_finalize_large1_results.sh"
echo
echo "Status:"
